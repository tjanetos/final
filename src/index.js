...
var base = Rebase.createClass({
  apiKey: "AIzaSyBV2OT-qWeYhYVf6j1OO09qrW_YYyOCSyM",   // replace with your Firebase application's API key
  databaseURL: "https://final-project-92999.firebaseio.com/", // replace with your Firebase application's database URL
})
    ...
    return (
      <div className="map col-sm-12">
        <Gmaps width={'100%'}
               ...
               lng={'-87.6285782'}
               zoom={11}
               loadingMessage={'Theatres Loading...'}
      ...
      <div className="sort row">
        <div className="col-sm-12">
          <ul className="nav nav-pills">
            <li onClick={this.changeClassLatest} className={this.state.className1}><a href="#" onClick={() => this.viewChanged('latest')}>Latest Releases</a></li>
            <li onClick={this.changeClassAlpha} className={this.state.className2}><a href="#" onClick={() => this.viewChanged('alpha')}>A-Z</a></li>
            <li onClick={this.changeClassMap} className={this.state.className3}><a href="#" onClick={() => this.viewChanged('map')}>Where to Watch</a></li>
